...
class CodeFixEnvironment(Environment):
    ...
    def get_agent_view(self, agent_id: str) -> Dict[str, Any]:
        ...
        view["available_actions"] = [
            {"action_type": "propose_fix", "method_id": "method_1", "fix_code": "<your_fixed_code>"},
            {"action_type": "share_snippet", "method_id": "method_1", "fix_code": "<your_fixed_code>"},
            {"action_type": "steal_snippet", "target_id": "<agent_id>", "resource_key": "<method_id>"},
            {"action_type": "pass"}
        ]
        return view
